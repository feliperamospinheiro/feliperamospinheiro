...
# Projects:  
- 🌐 100ceo Gateway: A data engineering MVP that simulates a payment gateway, using a Databricks Lakehouse (Bronze, Silver, Gold) to analyze transactions, fraud, and chargebacks with Spark and Delta Lake. [PT-BR](https://github.com/feliperamospinheiro/100cep-gateway-pt-br) | [ENG-US](https://github.com/feliperamospinheiro/100cep-gateway-english)

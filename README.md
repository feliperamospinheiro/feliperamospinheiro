...
# Projects:  
- 🌐 [100cep Gateway](https://github.com/feliperamospinheiro/100cep-gateway): A data engineering MVP that simulates a payment gateway, using a Databricks Lakehouse (Bronze, Silver, Gold) to analyze transactions, fraud, and chargebacks with Spark and Delta Lake.

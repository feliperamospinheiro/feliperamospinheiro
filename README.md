...
# Projects:  
- 🌐 100cep Gateway: A data engineering MVP that simulates a payment gateway, using a Databricks Lakehouse (Bronze, Silver, Gold) to analyze transactions, fraud, and chargebacks with Spark and Delta Lake. [EN-US](https://github.com/feliperamospinheiro/100cep-gateway-en) | [PT-BR](https://github.com/feliperamospinheiro/100cep-gateway-pt-br)

- 🌎 Air Quality in São Paulo: Exploratory analysis and visualization of hourly NO₂ levels across São Paulo regions, with median imputation by station and IQR-based outlier removal using Python, Pandas, and Seaborn. Focused on daily patterns to inform mobility and environmental policies. [EN-US](https://github.com/feliperamospinheiro/air-quality-en) | [PT-BR](https://github.com/feliperamospinheiro/qualidade-do-ar-pt-br)
